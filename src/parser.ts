...
*         '}'
*     }?
* DefnStmt  := id=ID _ ':=' _ expr=Expr
* AssgnStmt := id=ID _ '=' _ expr=Expr
* Expr      := And
...
export interface Stmt_3 {
    kind : ASTKinds.Stmt_3;
    asgn : DefnStmt;
}
export interface Stmt_4 {
    kind : ASTKinds.Stmt_4;
    expr : Expr;
}
...
export class Parser {
    ...
    matchProgram($$dpth : number, cr? : ContextRecorder) : Nullable<Program> {
        return this.loop<Stmt>(()=> this.matchStmt($$dpth + 1, cr), true);
    }
    matchStmt($$dpth : number, cr? : ContextRecorder) : Nullable<Stmt> {
        return this.choice<Stmt>([
            () => { return this.matchStmt_1($$dpth + 1, cr) },
            () => { return this.matchStmt_2($$dpth + 1, cr) },
            () => { return this.matchStmt_3($$dpth + 1, cr) },
            () => { return this.matchStmt_4($$dpth + 1, cr) },
        ]);
    }
    matchStmt_1($$dpth : number, cr? : ContextRecorder) : Nullable<Stmt_1> {
        return this.runner<Stmt_1>($$dpth,
            (log) => {
                if(log)
                    log('Stmt_1');
                let ifst : Nullable<IfStmt>;
                let res : Nullable<Stmt_1> = null;
                if(true
                    && this.match_($$dpth + 1, cr) != null
                    && (ifst = this.matchIfStmt($$dpth + 1, cr)) != null
                    && this.match_($$dpth + 1, cr) != null
                )
                    res = {kind: ASTKinds.Stmt_1, ifst : ifst};
                return res;
            }, cr)();
    }
    matchStmt_2($$dpth : number, cr? : ContextRecorder) : Nullable<Stmt_2> {
        return this.runner<Stmt_2>($$dpth,
            (log) => {
                if(log)
                    log('Stmt_2');
                let asgn : Nullable<AssgnStmt>;
                let res : Nullable<Stmt_2> = null;
                if(true
                    && this.match_($$dpth + 1, cr) != null
                    && (asgn = this.matchAssgnStmt($$dpth + 1, cr)) != null
                    && this.match_($$dpth + 1, cr) != null
                )
                    res = {kind: ASTKinds.Stmt_2, asgn : asgn};
                return res;
            }, cr)();
    }
    matchStmt_3($$dpth : number, cr? : ContextRecorder) : Nullable<Stmt_3> {
        return this.runner<Stmt_3>($$dpth,
            (log) => {
                if(log)
                    log('Stmt_3');
                let asgn : Nullable<DefnStmt>;
                let res : Nullable<Stmt_3> = null;
                if(true
                    && this.match_($$dpth + 1, cr) != null
                    && (asgn = this.matchDefnStmt($$dpth + 1, cr)) != null
                    && this.match_($$dpth + 1, cr) != null
                )
                    res = {kind: ASTKinds.Stmt_3, asgn : asgn};
                return res;
            }, cr)();
    }
    matchStmt_4($$dpth : number, cr? : ContextRecorder) : Nullable<Stmt_4> {
        return this.runner<Stmt_4>($$dpth,
            (log) => {
                if(log)
                    log('Stmt_4');
                let expr : Nullable<Expr>;
                let res : Nullable<Stmt_4> = null;
                if(true
                    && this.match_($$dpth + 1, cr) != null
                    && (expr = this.matchExpr($$dpth + 1, cr)) != null
                    && this.match_($$dpth + 1, cr) != null
                )
                    res = {kind: ASTKinds.Stmt_4, expr : expr};
                return res;
            }, cr)();
    }
        ...
        return this.runner<IfStmt>($$dpth,
            (log) => {
                if(log)
                    log('IfStmt');
                let expr : Nullable<Expr>;
                let seq : Nullable<Stmt[]>;
                let elsebranch : Nullable<Nullable<IfStmt_$0>>;
                let res : Nullable<IfStmt> = null;
                if(true
                    && this.regexAccept(String.raw`má`, $$dpth+1, cr) != null
                    && (expr = this.matchExpr($$dpth + 1, cr)) != null
                    && this.regexAccept(String.raw`{`, $$dpth+1, cr) != null
                    && (seq = this.loop<Stmt>(()=> this.matchStmt($$dpth + 1, cr), true)) != null
                    && this.regexAccept(String.raw`}`, $$dpth+1, cr) != null
                    && ((elsebranch = this.matchIfStmt_$0($$dpth + 1, cr)) || true)
                )
                    res = {kind: ASTKinds.IfStmt, expr : expr, seq : seq, elsebranch : elsebranch};
                return res;
            }, cr)();
    }
    matchIfStmt_$0($$dpth : number, cr? : ContextRecorder) : Nullable<IfStmt_$0> {
        return this.runner<IfStmt_$0>($$dpth,
            (log) => {
                ...
                if(true
                    && this.match_($$dpth + 1, cr) != null
                    && this.regexAccept(String.raw`nó`, $$dpth+1, cr) != null
                    && this.match_($$dpth + 1, cr) != null
                    && this.regexAccept(String.raw`{`, $$dpth+1, cr) != null
                    && (seq = this.loop<Stmt>(()=> this.matchStmt($$dpth + 1, cr), true)) != null
                    && this.regexAccept(String.raw`}`, $$dpth+1, cr) != null
                )
                    res = {kind: ASTKinds.IfStmt_$0, seq : seq};
                return res;
            }, cr)();
    }
